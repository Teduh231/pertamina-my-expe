...
export function TransactionDetailContent({ transaction, boothId }: TransactionDetailContentProps) {
  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto">
      <div className="flex items-center gap-4">
        <Button variant="outline" size="icon" onClick={() => router.push(`/booth-dashboard/${boothId}/pos`)}>
