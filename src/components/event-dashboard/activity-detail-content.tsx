...
export function ActivityDetailContent({ activity, participants, eventId }: ActivityDetailContentProps) {
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          <Button variant="outline" size="icon" onClick={() => router.push(`/event-dashboard/${eventId}/activity`)}>
