...
import { Event, Product, Activity, CheckIn } from '@/app/lib/definitions';
...
export function OverviewContent({ event, products, activities }: OverviewContentProps) {
    const totalCheckIns = event.check_ins?.length || 0;
    ...
    const dailyCheckins = React.useMemo(() => {
        ...
        event.check_ins?.forEach(checkIn => {
                 ...
                 <div className="lg:col-span-1">
                    <Card>
                        ...
                        <CardContent className="space-y-3">
                            <ActionButton href={`/event-dashboard/${event.id}/scanner`} icon={QrCode} variant="secondary">
                                Open QR Scanner
                            </ActionButton>
                    ...
                    <Card>
                        ...
                        <CardContent className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                            ...
                            <div className="flex items-center gap-4 text-sm p-3 bg-muted rounded-md">
                                ...
                                <span>Manager: {event.event_manager}</span>
                            </div>
                             <div className="flex items-center gap-4 text-sm p-3 bg-muted rounded-md">
