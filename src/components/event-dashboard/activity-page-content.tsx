...
export function ActivityPageContent({ eventId, activities }: ActivityPageContentProps) {
  ...
  async function onSubmit(values: z.infer<typeof activitySchema>) {
    ...
    if (result.success) {
      toast({
        ...
        description: `"${values.name}" has been added to your event.`,
      });
      form.reset();
      ...
      <TabsContent value="current" className="mt-6">
        <Card>
            <CardHeader>
                ...
                <CardDescription>An overview of all activities for this event.</CardDescription>
            </CardHeader>
            <CardContent>
                            ...
                            <Card key={activity.id} className="flex flex-col">
                                ...
                                <CardFooter className="flex items-center gap-2">
                                    <Button asChild className="flex-1">
                                        <Link href={`/event-dashboard/${eventId}/activity/${activity.id}`}>
